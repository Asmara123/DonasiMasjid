                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Selamat Datang! | Halaman Login Donasi Masjid</h1>
                                    </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <p class="h6" style="display: inline;">Belum Punya Akun?</p><a class="small" href="<?=BASEURL ;?>/auth/register"> Buat Akun</a>
                                    </div>
                                </div>
                            </div>
                        </div>
